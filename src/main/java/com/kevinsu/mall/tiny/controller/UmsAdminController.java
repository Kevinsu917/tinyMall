...
import com.kevinsu.mall.tiny.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    @RequestMapping(value = "/passwordInit", method = RequestMethod.POST)
    @ResponseBody
    public CommonResult initPassword(@RequestBody UmsAdminLoginParam userParam){
        return CommonResult.success(adminService.passwordInit(userParam.getUsername(), userParam.getPassword()));
    }
}
